...
$tinybrowser['path']['image'] = '/assets/upload/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/assets/upload/multimedia'; // Media files location
$tinybrowser['path']['file']  = '/assets/upload/files'; // Other files location
